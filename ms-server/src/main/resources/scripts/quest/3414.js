importPackage(Packages.asia.wmj.ms.client);
...
function end(mode, type, selection) {
	...
	if(status == 0) {
	    ...
	    if(qm.getPlayer().getInventory(Packages.asia.wmj.ms.client.inventory.MapleInventoryType.USE).getNumFreeSlot() < 1) {
		...
		return;
            ...
            if(stance == Packages.asia.wmj.ms.client.MapleJob.WARRIOR || stance == Packages.asia.wmj.ms.client.MapleJob.BEGINNER) vecItem = new Array(2043002, 2043102, 2043202, 2044002, 2044102, 2044202, 2044402, 2044302);
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.MAGICIAN) vecItem = new Array(2043702, 2043802);
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.BOWMAN || stance == Packages.asia.wmj.ms.client.MapleJob.CROSSBOWMAN) vecItem = new Array(2044502, 2044602);
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.THIEF) vecItem = new Array(2043302, 2044702);
