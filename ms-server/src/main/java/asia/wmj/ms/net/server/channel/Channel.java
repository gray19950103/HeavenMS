 ...
 */
package asia.wmj.ms.net.server.channel;
...
import asia.wmj.ms.scripting.event.EventScriptManager;
...
public final class Channel {
    ...
    private static String [] getEvents(){
    	...
    	for (File file : new File("src/main/resources/scripts/event").listFiles()){
