...
function start() {
    ...
    var snackBar = Packages.asia.wmj.ms.server.life.MapleLifeFactory.getMonster(8220008);
	...
	if(snackBarMap.getMonsterById(8220008) != null || snackBarMap.getMonsterById(8220009) != null) {
        ...
        snackBarMap.broadcastMessage(Packages.asia.wmj.ms.tools.MaplePacketCreator.serverNotice(6, "Slowly, a suspicious food stand opens up on a strangely remote place."));
	em.schedule("start", 3 * 60 *60 * 1000);
}
