...
function start() {
    ...
    var mobObj = Packages.asia.wmj.ms.server.life.MapleLifeFactory.getMonster(6090002);
    ...
    mapObj.broadcastMessage(Packages.asia.wmj.ms.tools.MaplePacketCreator.serverNotice(6, "From amongst the ruins shrouded by the mists, Bamboo Warrior appears."));
	em.schedule("start", 3 * 60 *60 * 1000);
}
