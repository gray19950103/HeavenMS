...
*/
package asia.wmj.ms.client.command;

import asia.wmj.ms.client.MapleClient;
import asia.wmj.ms.client.command.commands.gm0.*;
import asia.wmj.ms.client.command.commands.gm1.*;
import asia.wmj.ms.client.command.commands.gm2.*;
import asia.wmj.ms.client.command.commands.gm3.*;
import asia.wmj.ms.client.command.commands.gm4.*;
import asia.wmj.ms.client.command.commands.gm5.*;
import asia.wmj.ms.client.command.commands.gm6.*;
