...
function end(mode, type, selection) {
	...
	if(status == 0) {
		...
		return;
            ...
            if(stance == Packages.asia.wmj.ms.client.MapleJob.WARRIOR) item = 1082024;
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.MAGICIAN) item = 1082063;
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.BOWMAN || stance == Packages.asia.wmj.ms.client.MapleJob.CROSSBOWMAN) item = 1082072;
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.THIEF) item = 1082076;
            else if(stance == Packages.asia.wmj.ms.client.MapleJob.BRAWLER || stance == Packages.asia.wmj.ms.client.MapleJob.GUNSLINGER) item = 1082195;
            else item = 1082149;
