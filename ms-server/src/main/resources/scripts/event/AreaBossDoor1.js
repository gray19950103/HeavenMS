...
function start() {
    ...
    var boss = Packages.asia.wmj.ms.server.life.MapleLifeFactory.getMonster(bossMobid);
    map.spawnMonsterOnGroundBelow(boss, bossPos);
    map.broadcastMessage(Packages.asia.wmj.ms.tools.MaplePacketCreator.serverNotice(6, bossMsg));
