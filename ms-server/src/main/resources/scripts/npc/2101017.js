...
importPackage(Packages.asia.wmj.ms.server.expeditions);
...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        } else if (Packages.asia.wmj.ms.constants.game.GameConstants.isAriantColiseumArena(cm.getPlayer().getMapId())) {
