...
function start() {
        gachaMessages = Packages.asia.wmj.ms.server.gachapon.MapleGachapon.Gachapon.getLootInfo();
        gachas = Packages.asia.wmj.ms.server.gachapon.MapleGachapon.Gachapon.values();
