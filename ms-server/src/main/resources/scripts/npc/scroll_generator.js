...
importPackage(Packages.asia.wmj.ms.config);
importPackage(Packages.asia.wmj.ms.constants.game);
importPackage(Packages.asia.wmj.ms.server);
importPackage(Packages.asia.wmj.ms.server.life);
...
function generateRandomScroll() {
    if (cm.getPlayer().getInventory(Packages.asia.wmj.ms.client.inventory.MapleInventoryType.USE).getNumFreeSlot() >= 1) {
