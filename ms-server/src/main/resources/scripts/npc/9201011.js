...
importPackage(Packages.asia.wmj.ms.net.server.channel.handlers);
importPackage(Packages.asia.wmj.ms.tools);
importPackage(Packages.asia.wmj.ms.tools.packets);
